...
<div class="mainmenu-wrapper">
    <div class="container">
                    ...
                    <li>
                        <div class="dropdown choose-country">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li role="menuitem"><a href="#"><img src="../../resources/img/flags/us.png"
                                                                     alt="United States"> US</a></li>
                                <li role="menuitem"><a href="#"><img src="../../resources/img/flags/de.png"
                                                                     alt="Germany"> DE</a></li>
                                <li role="menuitem"><a href="#"><img src="../../resources/img/flags/es.png" alt="Spain">
                                    ES</a></li>
                            </ul>
                        </div>
                    </li>
        ...
        <nav id="mainmenu" class="mainmenu">
            <ul>
                <li class="logo-wrapper"><a href="index.jsp"><img src="../../resources/img/mPurpose-logo.png"
                    ...
                    <div class="mainmenu-submenu">
                        <div class="mainmenu-submenu-inner">
                            <div>
                                <h4>Homepage</h4>
                                <ul>
                                    <li><a href="index.jsp">Homepage (Sample 1)</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="calltoaction-wrapper">
                    <h3>It's a free multipurpose Bootstrap 3 template!</h3> <a href="http://www.dragdropsite.com"
        ...
        <div class="row">
            ...
            <div class="testimonial col-md-4 col-sm-6">
                ...
                <div class="author-photo">
                    <img src="../../resources/img/user1.jpg" alt="Author 1">
                </div>
            ...
            <div class="testimonial col-md-4 col-sm-6">
                <div class="author-photo">
                    <img src="../../resources/img/user5.jpg" alt="Author 2">
                </div>
                <div class="testimonial-bubble">
                    <blockquote>
                        <p class="quote">
            ...
            <div class="testimonial col-md-4 col-sm-6">
                <div class="author-photo">
                    <img src="../../resources/img/user2.jpg" alt="Author 3">
                </div>
                <div class="testimonial-bubble">
                    <blockquote>
                        <p class="quote">
            ...
            <div class="col-footer col-md-3 col-xs-6">
                ...
                <div class="portfolio-item">
                    <div class="portfolio-image">
                        <a href="page-portfolio-item.html"><img src="../../resources/img/portfolio6.jpg"
                                                                alt="Project Name"></a>
                    </div>
                </div>
            </div>
