...
<div class="homepage-slider">
    <div id="sequence">
        <ul class="sequence-canvas">
            <!-- Slide 1 -->
            <li class="bg4">
                <h2 class="title">Some railway company</h2>
                <h3 class="subtitle">From the past to the future</h3>
                <img class="slide-img" src="resources/img/homepage-slider/slide1.png" alt="Slide 1"/>
            </li>
            <!-- Slide 2 -->
            <li class="bg3">
                <h2 class="title">Some railway company</h2>
                <h3 class="subtitle">The toilet is closed, the windows do not open</h3>
                <img class="slide-img" src="resources/img/homepage-slider/slide2.png" alt="Slide 2"/>
            </li>
            <!-- Slide 3 -->
            <li class="bg1">
                <h2 class="title">Some railway company</h2>
                <h3 class="subtitle">We change for you</h3>
